...
seq 1 990 | parallel -k -j 3 "echo 'tomahawk calc -i pmulti.Q1.norm.twk -o monotig-calc/pmulti.monotig.Q1.norm.calc.{} -a 2 -r 0.2 -P 0.01 -t 8 -c 990 -C {}' | run-bsub -a -m 16000 -A -q normal -c 8 -Panalysis-rd" >tomahawk-monotig.jobids
